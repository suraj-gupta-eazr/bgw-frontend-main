  ...
  return (
    <div className="slider-container w-full">
      <Slider className="" {...settings}>
        <div>
          <img
            className="w-full object-cover opacity-40 h-[610px] rounded-xl"
            src={image1}
            alt=""
          />
        </div>
...
const Hero = () => {
  ...
  return (
    <div className="bg-white h-full w-screen py-28 px-6 lg:px-20 ">
      <SimpleSlider />
      <div className="m-6 md:ml-24 md:w-1/2 absolute top-44">
        <h1 className="md:text-6xl sm:text-5xl text-4xl font-nunito text-slate-800 font-bold">
          Welcome to <span className="text-[#0A8935]">Bhangarwala</span>
        </h1>
        <h2 className="md:text-4xl sm:text-3xl text-2xl font-nunito text-[#474747] my-4">
        ...
        <div className="flex gap-2 mt-6">
          <a
            ...
            className="flex items-center px-7 py-4 text-white rounded-full font-bold gap-2 bg-[#0A8935] "
          >
            <MdCall size={24} />
            Call Now
          </a>
          ...
          <button
            onClick={() => setOpen(1)}
            className="flex items-center px-7 py-4 text-[#0A8935] rounded-full font-bold gap-2 bg-[#CBF1DA] "
          >
             <FaShoppingCart  size={24} />Sell Now 
          </button>
        </div>
        ...
        <button
            ...
            className="flex items-center px-7 py-4 text-[#0A8935] rounded-full font-bold gap-2 bg-[#CBF1DA] "
          >
            <TbTruckDelivery size={24} />Bulk Now  
          </button>
